...
type VideoUser struct {
	...
	AttendCount   float64   `gorm:"column:attend_count;type:double;comment:关注数;default:NULL;" json:"attend_count"`                // 关注数
	FansCount     float64   `gorm:"column:fans_count;type:double;comment:粉丝数;default:NULL;" json:"fans_count"`                    // 粉丝数
	ZanCount      float64   `gorm:"column:zan_count;type:double;comment:点赞数;default:NULL;" json:"zan_count"`                      // 点赞数
	Status        string    `gorm:"column:status;type:varchar(20);comment:用户状态;default:NULL;" json:"status"`                     // 用户状态
	AvatorFileId  int16     `gorm:"column:avator_file_id;type:smallint;comment:头像关联id;default:NULL;" json:"avator_file_id"`      // 头像关联id
	...
	Age           int16     `gorm:"column:age;type:smallint;comment:年龄;default:NULL;" json:"age"`                                  // 年龄
	...
	Level         int16     `gorm:"column:level;type:smallint;comment:用户等级;default:NULL;" json:"level"`                          // 用户等级
	Balance       int16     `gorm:"column:balance;type:smallint;comment:余额;default:NULL;" json:"balance"`                          // 余额
