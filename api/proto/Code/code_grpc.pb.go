...
const (
	Code_SendCode_FullMethodName = "/code/SendCode"
)
...
func (c *codeClient) SendCode(ctx context.Context, in *SendCodeReq, opts ...grpc.CallOption) (*SendCodeRes, error) {
...
func (UnimplementedCodeServer) SendCode(context.Context, *SendCodeReq) (*SendCodeRes, error) {
...
func _Code_SendCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CodeServer).SendCode(ctx, req.(*SendCodeReq))
	}
